...
Open the sketch under `../Firmware/ESP-RotaryCell_v0.8/`, select the appropriate ESP32-S3 board and port, compile, and upload. Open the serial monitor at 115200 baud.
