...
// -----------------------------------------------------------------------------
// Development-only INA226 + microSD power logger
// LilyGO T-A7670X-S3 Standard Rev 1.0 schematic pin assignments.
// -----------------------------------------------------------------------------
...
constexpr uint32_t POWER_LOG_SAMPLE_INTERVAL_MS = 100;  // 10 samples/second
...
// -----------------------------------------------------------------------------
constexpr const char* FIRMWARE_VERSION = "0.10.4-INA226-SD-dev";
